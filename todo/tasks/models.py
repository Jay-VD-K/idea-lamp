...
PRIORITIES = (
        ('adanger', 'Difficulty High'),
        ('bwarning', 'Difficulty Medium'),
        ('csuccess', 'Difficulty Low')
    )
...
class TaskForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'placeholder': "Describe your idea ..", 'cols': 80, 'rows': 3}),
        }
